...
| Total Household Income | TOT_IN | A qualitative measure that identifies the average total household income of adult residents of a state. 13 possible levels in the data range from \$42,500 to \$44,999 to \$70,000 to \$72,499, each capturing a \$2,499 range in household income. | 
...
| Age | AGE | A continuous quantitative measure that reports the average age of a state's adult residents in years. Values range from 40.83460 to 46.39759. An age of 40.83460 indicates a person who is 40 years old and approximately 305 days old. | 

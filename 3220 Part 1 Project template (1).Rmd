...
The final scatterplot depicts the relationship between the urban population percentage of a state and the average Personal earnings. In addition, the scatterplot groups the states by gender with blue representing states with a majority male population and pink representing states with a majority female population. The correlation coefficient of the graph is .579 signifying that there is a moderate correlation between urban population percentage and average personal earnings. The graph shows that the vast majority of states are male-dominated but the range of these male-dominated states is large suggesting that gender plays very little role in average earnings. There are only 5 female-dominated states but ⅗ of them lay in a cluster within the 70-80% urban population range which means there may be less of a earnings range for female-dominated states.  But, due to the two remaining women-dominated states being outliers, it is unclear if this cluster is meaningful or not. Ultimately, while the correlation is not the strongest, the urban population variable does still provide information and is viable for a model.

...
RatesofStates<-c(6.4,8.3,7.8,6.2,10.1,6.8,7.9,7.5,7.9,8.1,6.5,11.7,5.5,9.3,7.3,5.2,5.8,6.5,8.6,5.1,6.5,9.4,10.0,6.3,8.0,6.1,5.8,4.3,13.5,6.7,9.4,7.9,9.8,7.2,5.0,8.2,6.3,7.6,8.9,9.2,6.0,4.2,7.5,7.7,4.8,5.7,6.5,8.5,8.2,6.4,5.9)

# Merge the two vectors
UnemploymentRates<-data.frame(StatesbyFIPS, RatesofStates)

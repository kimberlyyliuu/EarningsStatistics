...
incomeData$Education_Level <- cut(incomeData$H_ED,
                            breaks = c(38.5, 39.5, 40.5, 41.5, 42.5, 43.5),
...
ggplot(incomeData, aes(x = H_ED, y = PEARNVAL, color = Education_Level)) +
  geom_point() +
  scale_color_manual(values = c("High School Graduate" = "lightblue",
                                "Some College but No Degree" = "lightgreen",
                                "Associate Degree - Occupational/Vocational" = "lightpink",
                                "Associate Degree - Academic Program" = "lightblue",
                                "Bachelor's Degree" = "orange")) +
  labs(x = "Highest Education (Numeric)", y = "Personal Earnings (PEARNVAL)", color = "Educational Attainment", title = "Educational Attainment vs Personal Earnings") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

### Scatterplot of total income (PEARNVAL) by age
    plot(incomeData$PEARNVAL, incomeData$AGE, main="Earnings by Age")
    cor(incomeData$PEARNVAL, incomeData$AGE)
###Scatterplot of total income (PEARNVAL) by health status (HEA) 
    plot(incomeData$PEARNVAL, incomeData$HEA, main= "Earnings by Health Status")
    cor(incomeData$PEARNVAL, incomeData$HEA)
### Scatterplot of Average Total Income by Gender across Different Urbanization Levels

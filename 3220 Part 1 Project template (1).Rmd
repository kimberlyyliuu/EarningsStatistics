...
The scatterplot of “Age vs Personal Earnings” depicts the relationship between the  personal earnings corresponding to a state and the average age of adult individuals in each respective state. From the EDA, a correlation coefficient of -0.103 suggests the age variable has no significant association with personal earnings. There is an outlier corresponding to Washington D.C., indicated by the large difference in personal earnings relative to the other variables. This is most likely due to the high cost of living in a metropolitan city. Due to the low correlation coefficient and the lack of a distinctive pattern, age would likely not be a significant contributor to the model. 
...
| \textbf{Work Expenses} | WRK_SPND |

A continuous quantitative measure that identifies the average amount of money spent on work-related expenses among residents of a state, reported in U.S. Dollars. Possible values in the data range from \$1101.676 to \$1463.411. |

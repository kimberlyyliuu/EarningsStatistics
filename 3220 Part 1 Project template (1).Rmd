...
The boxplot “Personal Earnings by Health Status across States” suggests a significant relationship between health and personal earnings; a good health status resulted in median personal earning of \$54,810, while a very good health status resulted in median personal earning of \$54,810. The data supports the conclusion that better health leads to greater personal earning. However, before utilization in a prediction model, the unequal reporting of levels must be considered; a very good health status was only reported by 9 territories, with the remaining 42 states reporting a good health status. This under-reporting of the very good health status model could lead to error in the model. A stratified sampling method may be employed to evenly sample levels of health status if it is believed to contribute significant error to the model. 

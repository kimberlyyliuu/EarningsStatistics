...
```
The histogram titled “Distribution of Personal Earnings by State” depicts the distribution of the response, personal earnings. The histogram is approximately symmetric and unimodal with a potential outlier at  ~\$95,000. The computed median of the personal earnings  is \$55,946.86. The computed mean of personal earnings is \$58,472.35. Containment of the mean within the range of possible values for the median suggests minimal skew.  

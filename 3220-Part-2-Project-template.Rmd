...
## Conclusions
Our model shows that increase in urban percentile (URB_PER) leads to higher personal earnings whereas possession of a higher education vocational associate's degree (H_EDvassoc) results in lower personal earnings in the United States. With a low R² of 0.5792 and a high mean squared error of 0.0001, the model is not a strong predictor of personal earnings.
